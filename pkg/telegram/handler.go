...
func (b *Bot) handleSettingCommand(message *tgbotapi.Message) error {
	...
	✔️ gpt-3.5-turbo — модель является наиболее популярной и доступной. Специально оптимизирована для чатов, отлично справляется с генерацией текста Лимит токенов: 4096.
